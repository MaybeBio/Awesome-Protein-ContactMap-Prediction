...
Sources: [chai_lab/utils/typing.py L23-L33](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/chai_lab/utils/typing.py#L23-L33)
 ...
 [chai_lab/utils/typing.py L7-L19](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/chai_lab/utils/typing.py#L7-L19)
...
* **Implementation**: If `should_typecheck` is `True`, it returns the function or class wrapped by `jaxtyped(typechecker=beartype)`. Otherwise, it returns the original object with no runtime overhead [chai_lab/utils/typing.py L29-L33](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/chai_lab/utils/typing.py#L29-L33)
* **Scope**: It can be applied to both functions and classes [chai_lab/utils/typing.py L29](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/chai_lab/utils/typing.py#L29-L29)

### Configuration: should_typecheck

The global flag `should_typecheck` controls the enforcement of types.

* **Persistence**: Because modules are only loaded once, the value of `should_typecheck` remains constant over the lifetime of the program [chai_lab/utils/typing.py L21-L23](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/chai_lab/utils/typing.py#L21-L23)
* **Default**: It is currently set to `True` [chai_lab/utils/typing.py L23](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/chai_lab/utils/typing.py#L23-L23)
...
Sources: [chai_lab/utils/typing.py L8-L19](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/chai_lab/utils/typing.py#L8-L19)

 [chai_lab/utils/typing.py L36-L48](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/chai_lab/utils/typing.py#L36-L48)
...
Sources: [chai_lab/utils/typing.py L16](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/chai_lab/utils/typing.py#L16-L16)

 [chai_lab/utils/typing.py L29-L31](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/chai_lab/utils/typing.py#L29-L31)
...
When a type or shape mismatch occurs at runtime, the system raises a `TypeCheckError` [chai_lab/utils/typing.py L16](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/chai_lab/utils/typing.py#L16-L16)

 This exception is re-exported in the `__all__` list of the typing utility for easy catching during testing or debugging [chai_lab/utils/typing.py L38](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/chai_lab/utils/typing.py#L38-L38)
...
Sources: [chai_lab/utils/typing.py L29-L33](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/chai_lab/utils/typing.py#L29-L33)

The use of `typing.TypeVar("Func")` ensures that the decorator maintains the type signature of the wrapped function or class for static analysis tools like `mypy` [chai_lab/utils/typing.py L26-L29](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/chai_lab/utils/typing.py#L26-L29)

Sources: [chai_lab/utils/typing.py L1-L49](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/chai_lab/utils/typing.py#L1-L49)