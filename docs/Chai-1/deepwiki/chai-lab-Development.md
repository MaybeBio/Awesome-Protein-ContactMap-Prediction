...
owner: chaidiscovery
repo: chai-lab
url: https://deepwiki.com/chaidiscovery/chai-lab/9-development
---
# Development
...
> - [chai\_lab/utils/typing\.py](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/chai_lab/utils/typing.py)
 ...
 For end\-users looking to use Chai\-1 for structure prediction, please refer to [Getting Started](https://deepwiki.com/chaidiscovery/chai-lab/2-getting-started)\. For detailed information on specific development topics, see the subsections: [Type System](https://deepwiki.com/chaidiscovery/chai-lab/9.1-type-system), [Testing Framework](https://deepwiki.com/chaidiscovery/chai-lab/9.2-testing-framework), and [CI/CD Pipeline](https://deepwiki.com/chaidiscovery/chai-lab/9.3-cicd-pipeline)\.
...
```
 ...
 Sources: [\_\_init\_\_\.py L1-L6](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/chai_lab/__init__.py#L1-L6) [typing\.py L1-L49](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/chai_lab/utils/typing.py#L1-L49) [ruff\.yml L1-L29](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/.github/workflows/ruff.yml#L1-L29)
...
| --- | --- | --- |
| MYPY\_CACHE\_DIR | /tmp/\.chai\_lab\_mypy\_cache | Keeps large mypy cache outside the working tree Dockerfile\.chailab11 |
| PYTHONPYCACHEPREFIX | /tmp/\.chai\_lab\_pycache | Keeps \_\_pycache\_\_ out of the source tree Dockerfile\.chailab17 |
| PYTHONFAULTHANDLER | 1 | Prints tracebacks after segfaults Dockerfile\.chailab15 |
| VIRTUAL\_ENV | /opt/venv | Location of the virtual environment Dockerfile\.chailab60 |
...
TypeCheck -->|"calls if should_typecheck=True"| JaxTyped
...
```
 ...
 Sources: [typing\.py L23-L33](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/chai_lab/utils/typing.py#L23-L33)

 For details, see [Type System](https://deepwiki.com/chaidiscovery/chai-lab/9.1-type-system)\.
...
- **Static Analysis**: The project uses `mypy` for static type checking and `ruff` for linting and formatting\.
 ...
 For details, see [Testing Framework](https://deepwiki.com/chaidiscovery/chai-lab/9.2-testing-framework)\.
...
RuffJob -->|"runs"| PreCommit
MypyJob -->|"runs"| MypyCmd
PyPIJob -->|"runs"| HatchBuild
...
```
 ...
 Sources: [ruff\.yml L24-L28](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/.github/workflows/ruff.yml#L24-L28) [mypy\.yml L29](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/.github/workflows/mypy.yml#L29-L29) [publish\-to\-pypi\.yml L35](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/.github/workflows/publish-to-pypi.yml#L35-L35)

 For details, see [CI/CD Pipeline](https://deepwiki.com/chaidiscovery/chai-lab/9.3-cicd-pipeline)\.
...
```
 ...
 Sources: [\_\_init\_\_\.py L1-L3](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/chai_lab/__init__.py#L1-L3) [typing\.py L1-L3](https://github.com/chaidiscovery/chai-lab/blob/66c38d1f/chai_lab/utils/typing.py#L1-L3)

---
*Source: [https://deepwiki.com/chaidiscovery/chai-lab/9-development](https://deepwiki.com/chaidiscovery/chai-lab/9-development) on DeepWiki*