...
This page explains the fundamental concepts, terminology, and data structures used in RoseTTAFold All-Atom (RFAA). Understanding these concepts is essential for effectively using the system and interpreting its outputs. For information about using RFAA for specific tasks, see [Using RFAA](/baker-laboratory/RoseTTAFold-All-Atom/4-using-rfaa), and for details on the system architecture, see [System Architecture](/baker-laboratory/RoseTTAFold-All-Atom/5-system-architecture).
...
Sources: [rf2aa/data/data_loader.py L13-L163](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/data_loader.py#L13-L163)
...
* `chain_lengths`: List of (chain_id, length) tuples for each chain
...
Sources: [rf2aa/data/data_loader.py L13-L106](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/data_loader.py#L13-L106)
...
Sources: [rf2aa/data/data_loader.py L166-L202](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/data_loader.py#L166-L202)
...
Sources: [rf2aa/data/merge_inputs.py L9-L204](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/merge_inputs.py#L9-L204)
...
Sources: [rf2aa/data/merge_inputs.py L88-L95](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/merge_inputs.py#L88-L95)
...
Sources: [rf2aa/data/merge_inputs.py L97-L104](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/merge_inputs.py#L97-L104)
...
Sources: [rf2aa/data/data_loader.py L107-L163](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/data_loader.py#L107-L163)
...
| Term | Description |
| --- | --- |
| xyz_t | 3D coordinates from template structures |
| mask_t | Binary mask indicating valid template positions |
...
Sources: [README.md L214-L263](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L214-L263)
...
| pAE_inter | Mean pAE between different molecule types - key metric for interface quality |
...
2. **Chain Lengths**: Tracked in a list of (chain_id, length) tuples
...
Sources: [rf2aa/data/merge_inputs.py L161-L207](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/merge_inputs.py#L161-L207)

 [rf2aa/data/data_loader.py L37-L50](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/data_loader.py#L37-L50)
...
| Term | Description |
| --- | --- |
| msa_prev | MSA embedding from previous cycle |
| pair_prev | Pairwise features from previous cycle |
| state_prev | Hidden state from previous cycle |
...
Sources: [README.md L87-L90](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L87-L90)