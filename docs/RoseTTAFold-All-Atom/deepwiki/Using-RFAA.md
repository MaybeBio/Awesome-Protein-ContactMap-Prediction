...
Sources: [README.md L12-L19](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L12-L19)
...
Where `{your_inference_config}` refers to one of the predefined configuration files or a custom configuration you've created. For more detailed information about the configuration system, see [Configuration System](/baker-laboratory/RoseTTAFold-All-Atom/4.1-configuration-system).

Sources: [README.md L87-L93](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L87-L93)
...
Sources: [rf2aa/run_inference.py L21-L33](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L21-L33)
...
Sources: [README.md L104-L124](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L104-L124)
...
Sources: [README.md L180-L207](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L180-L207)
...
Sources: [README.md L209-L265](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L209-L265)
...
Sources: [rf2aa/run_inference.py L34-L94](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L34-L94)
 ...
 [rf2aa/run_inference.py L112-L133](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L112-L133)
...
| mean_plddt | Average confidence across all positions |
| mean_pae | Average predicted aligned error |
| pae_prot | Average predicted aligned error for protein residues only |
| pae_inter | Average predicted aligned error for interfaces between different molecule types |
...
Sources: [README.md L267-L281](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L267-L281)
 ...
 [rf2aa/run_inference.py L130-L149](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L130-L149)
...
For more details on preparing specific input files, see [Input File Preparation](/baker-laboratory/RoseTTAFold-All-Atom/4.2-input-file-preparation).
...
Sources: [README.md L95-L101](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L95-L101)
 ...
 [rf2aa/run_inference.py L34-L92](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L34-L92)