...
url: https://deepwiki.com/baker-laboratory/RoseTTAFold-All-Atom/5.2-input-merging
---
# Input Merging
...
## Purpose and Scope
 ...
 For information about how this data is initially loaded, see [Data Loading and Parsing](https://deepwiki.com/baker-laboratory/RoseTTAFold-All-Atom/5.3-data-loading-and-parsing)\. For details on what happens after input merging, see [Inference Pipeline](https://deepwiki.com/baker-laboratory/RoseTTAFold-All-Atom/5.4-inference-pipeline)\.
...
start --> check
check -->|"Single protein"| single
check -->|"Multiple proteins"| multiple
multiple --> hash
hash --> unique
unique -->|"Multiple unique sequences"| merge_hetero
unique -->|"Single unique sequence"| merge_homo
...
subgraph subGraph1 ["Merging Process"]
    loop
    merge
    loop -->|"For each input"| merge
    merge -->|"Update running_inputs"| loop
end
...
```
 ...
 Sources: [merge\_inputs\.py L88-L104](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/merge_inputs.py#L88-L104) [merge\_inputs\.py L106-L159](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/merge_inputs.py#L106-L159)
...
| --- | --- |
| MSAs | Uses merge\_a3m\_hetero to combine MSAs |
...
| Atom Frames | Simple concatenation |
 ...
 Sources: [merge\_inputs\.py L106-L159](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/merge_inputs.py#L106-L159)
...
```
 ...
 Sources: [merge\_inputs\.py L73-L74](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/merge_inputs.py#L73-L74) [merge\_inputs\.py L92-L94](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/merge_inputs.py#L92-L94) [merge\_inputs\.py L101-L103](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/merge_inputs.py#L101-L103) [merge\_inputs\.py L178-L179](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/merge_inputs.py#L178-L179)
...
### Bond Features
 ...
 Sources: [merge\_inputs\.py L127-L134](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/merge_inputs.py#L127-L134) [merge\_inputs\.py L190-L197](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/merge_inputs.py#L190-L197)
...
## Special Case: Covalent Modifications
 ...
 Sources: [merge\_inputs\.py L201-L202](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/merge_inputs.py#L201-L202)

---
*Source: [https://deepwiki.com/baker-laboratory/RoseTTAFold-All-Atom/5.2-input-merging](https://deepwiki.com/baker-laboratory/RoseTTAFold-All-Atom/5.2-input-merging) on DeepWiki*