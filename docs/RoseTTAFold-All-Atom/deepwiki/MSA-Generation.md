...
> * [input_prep/make_ss.sh](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/input_prep/make_ss.sh)
> * [make_msa.sh](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/make_msa.sh)
...
Sources: [make_msa.sh L1-L126](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/make_msa.sh#L1-L126)
...
Sources: [make_msa.sh L22-L30](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/make_msa.sh#L22-L30)
...
Sources: [make_msa.sh L35-L77](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/make_msa.sh#L35-L77)
...
Sources: [make_msa.sh L79-L112](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/make_msa.sh#L79-L112)
...
Sources: [make_msa.sh L114-L116](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/make_msa.sh#L114-L116)

 [input_prep/make_ss.sh L1-L33](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/input_prep/make_ss.sh#L1-L33)
...
Sources: [make_msa.sh L118-L125](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/make_msa.sh#L118-L125)
...
Client --> make_msa
make_msa --> CheckFiles
CheckFiles --> ShellCommand
CheckFiles --> ReturnPaths
...
Sources: [rf2aa/data/preprocessing.py L9-L34](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/preprocessing.py#L9-L34)
...
| --- | --- | --- |
| `command` | Path to the MSA generation script | "make_msa.sh" |
| `sequencedb` | Path to sequence databases | Contains UniRef30 and BFD paths |
| `num_cpus` | Number of CPU cores to use | Configurable |
...
Sources: [rf2aa/data/preprocessing.py L19-L23](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/preprocessing.py#L19-L23)
...
| --- | --- | --- |
| `t000_.msa0.a3m` | Multiple sequence alignment in A3M format | Feature construction, structure prediction |
| `t000_.ss2` | Secondary structure prediction | Feature construction |
| `t000_.hhr` | HHSearch results with template alignments | Template feature construction |
| `t000_.atab` | HHSearch results in tabular format | Template feature construction |
...
Sources: [make_msa.sh L61-L125](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/make_msa.sh#L61-L125)

 [rf2aa/data/preprocessing.py L25-L28](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/data/preprocessing.py#L25-L28)