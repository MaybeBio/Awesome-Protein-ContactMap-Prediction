...
The Inference Pipeline is the core execution pathway in RoseTTAFold All-Atom (RFAA) that transforms input biomolecular data into predicted 3D structures. This page documents the pipeline's implementation, workflow, and components. For information about preparing inputs for the pipeline, see [Input File Preparation](/baker-laboratory/RoseTTAFold-All-Atom/4.2-input-file-preparation). For understanding the output files, see [Understanding Output Files](/baker-laboratory/RoseTTAFold-All-Atom/4.4-understanding-output-files).
...
Sources: [rf2aa/run_inference.py L20-L208](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L20-L208)
...
Sources: [rf2aa/run_inference.py L151-L156](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L151-L156)
...
Sources: [rf2aa/run_inference.py L21-L32](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L21-L32)
...
| --- | --- |
| `allatom_mask` | Masks for different atom types |
| `atom_type_index` | Mapping of atoms to indices |
| `ljlk_parameters` | Lennard-Jones parameters |
| `num_bonds` | Bond count information |
| `cb_len`, `cb_ang`, `cb_tor` | Backbone geometry parameters |

Sources: [rf2aa/run_inference.py L96-L111](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L96-L111)
...
Sources: [rf2aa/run_inference.py L34-L94](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L34-L94)
...
Sources: [rf2aa/run_inference.py L112-L114](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L112-L114)
...
Sources: [rf2aa/run_inference.py L115-L127](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L115-L127)
...
Sources: [rf2aa/run_inference.py L130-L149](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L130-L149)
...
Sources: [rf2aa/run_inference.py L158-L165](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L158-L165)
...
Sources: [rf2aa/run_inference.py L167-L172](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L167-L172)
...
Sources: [rf2aa/run_inference.py L174-L179](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L174-L179)
...
| Metric | Description |
| --- | --- |
| mean_plddt | Average confidence across all residues |
| mean_pae | Average alignment error across all residue pairs |
| pae_prot | Average alignment error within protein regions |
| pae_inter | Average alignment error at interfaces |
...
Sources: [rf2aa/run_inference.py L181-L200](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L181-L200)
...
For details on the configuration options, see [Configuration System](/baker-laboratory/RoseTTAFold-All-Atom/4.1-configuration-system).

Sources: [rf2aa/run_inference.py L203-L206](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L203-L206)