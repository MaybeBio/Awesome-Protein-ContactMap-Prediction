...
This document explains the output files generated by RoseTTAFold All-Atom (RFAA) and how to interpret them to assess prediction quality. For information about preparing input files, see [Input File Preparation](/baker-laboratory/RoseTTAFold-All-Atom/4.2-input-file-preparation).
...
Sources: [rf2aa/run_inference.py L141-L147](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L141-L147)
...
Sources: [rf2aa/run_inference.py L158-L200](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L158-L200)
...
| mean_plddt | Average pLDDT across all positions | scalar | Overall structure confidence |
| mean_pae | Average PAE across all position pairs | scalar | Overall structural coherence |
| pae_prot | Average PAE for protein residue pairs | scalar | Protein structure quality |
| pae_inter | Average PAE for protein-ligand interfaces | scalar | Interface prediction quality |
| same_chain | Matrix indicating which nodes belong to same chain | [L×L] | Used to interpret PAE matrices |

Where L is the total length of the system (protein residues + nucleic acid residues + atoms in small molecules).

Sources: [README.md L274-L281](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L274-L281)

 [rf2aa/run_inference.py L181-L200](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L181-L200)
...
Sources: [rf2aa/run_inference.py L191-L199](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/run_inference.py#L191-L199)
...
subgraph subGraph0 ["Assessment Process"]
    ...
    ReliableRegion
    UnreliableRegion
    pae_inter --> HighConfidenceInterface
    pae_inter --> LowConfidenceInterface
    mean_plddt --> HighConfidenceOverall
    mean_plddt --> LowConfidenceOverall
    pae_prot --> HighConfidenceProtein
    pae_prot --> LowConfidenceProtein
    local_plddt --> ReliableRegion
    local_plddt --> UnreliableRegion
end
```

Sources: [README.md L279-L281](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L279-L281)
