...
url: https://deepwiki.com/baker-laboratory/RoseTTAFold-All-Atom/4.1-configuration-system
---
...
> - [rf2aa/config/inference/protein\_complex\_sm\.yaml](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/config/inference/protein_complex_sm.yaml)
 ...
 This document explains RoseTTAFold All\-Atom's \(RFAA\) configuration system, which uses the Hydra framework to manage parameters for structure prediction runs\. Understanding this system is essential for running prediction tasks with different types of molecules\. For preparing specific input files, see [Input File Preparation](https://deepwiki.com/baker-laboratory/RoseTTAFold-All-Atom/4.2-input-file-preparation)\.
...
User -->|"--config-name parameter"| HydraLoader
...
```
 ...
 Sources: [README\.md?plain=1 L86-L90](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L86-L90)
...
Base -->|"extends"| NA
Base -->|"extends"| SM
Base -->|"extends"| Complex
Base -->|"extends"| Covalent
Protein -->|"used by"| RunInf
NA -->|"used by"| RunInf
SM -->|"used by"| RunInf
Complex -->|"used by"| RunInf
Covalent -->|"used by"| RunInf
```

 Sources: [README\.md?plain=1 L87-L89](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L87-L89) [protein\_complex\_sm\.yaml L1-L3](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/config/inference/protein_complex_sm.yaml#L1-L3)

## Core Configuration Components

 Every RFAA configuration file includes these main components:

  Sources: [README\.md?plain=1 L92-L101](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L92-L101) [README\.md?plain=1 L112-L116](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L112-L116)
...
| job\_name | Name for output files | String \(default: "structure\_prediction"\) |
| protein\_inputs | Protein chain specifications | Dictionary with chain IDs as keys |
| na\_inputs | Nucleic acid chain specifications | Dictionary with chain IDs as keys |
| sm\_inputs | Small molecule specifications | Dictionary with chain IDs as keys |
| covale\_inputs | Covalent bond specifications | String with special syntax \(see below\) |
| loader\_params | Model parameters | Dictionary of parameter name/value pairs |

 Sources: [README\.md?plain=1 L92-L101](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L92-L101) [README\.md?plain=1 L108-L144](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L108-L144)
...
```
 ...
 Sources: [README\.md?plain=1 L112-L116](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L112-L116)
...
```
 ...
 Sources: [README\.md?plain=1 L135-L143](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L135-L143)
...
- `CHIRALITY1`, `CHIRALITY2`: New chirality specifications, can be "CW", "CCW", or "null"
 ...
 Sources: [README\.md?plain=1 L217-L262](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L217-L262)
...
```
 ...
 Sources: [README\.md?plain=1 L108-L116](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L108-L116)
...
```
 ...
 Sources: [README\.md?plain=1 L129-L144](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L129-L144)
...
```
 ...
 Sources: [README\.md?plain=1 L156-L172](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L156-L172) [protein\_complex\_sm\.yaml L1-L14](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/rf2aa/config/inference/protein_complex_sm.yaml#L1-L14)
...
```
 ...
 Sources: [README\.md?plain=1 L233-L252](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L233-L252)
...
```
 ...
 Sources: [README\.md?plain=1 L93-L94](https://github.com/baker-laboratory/RoseTTAFold-All-Atom/blob/6c851405/README.md?plain=1#L93-L94)

---
*Source: [https://deepwiki.com/baker-laboratory/RoseTTAFold-All-Atom/4.1-configuration-system](https://deepwiki.com/baker-laboratory/RoseTTAFold-All-Atom/4.1-configuration-system) on DeepWiki*