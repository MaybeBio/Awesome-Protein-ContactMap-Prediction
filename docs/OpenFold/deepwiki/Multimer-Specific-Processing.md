...
For information about the base data pipeline, see [Data Pipeline and Feature Generation](/aqlaboratory/openfold/6.1-data-pipeline-and-feature-generation). For MSA and template processing differences in multimer mode, see [MSA and Template Processing](/aqlaboratory/openfold/6.3-msa-and-template-processing). For the AlphaFold model itself, see [AlphaFold Model Overview](/aqlaboratory/openfold/5.2-alphafold-model-overview).

**Sources:** [openfold/data/data_modules.py L292-L504](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/data/data_modules.py#L292-L504)

 [openfold/utils/multi_chain_permutation.py L1-L543](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/multi_chain_permutation.py#L1-L543)

 [train_openfold.py L109-L112](https://github.com/aqlaboratory/openfold/blob/56da08ec/train_openfold.py#L109-L112)
...
**Sources:** [openfold/data/data_modules.py L292-L354](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/data/data_modules.py#L292-L354)

 [openfold/data/data_modules.py L664-L754](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/data/data_modules.py#L664-L754)

 [openfold/data/data_modules.py L1062-L1133](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/data/data_modules.py#L1062-L1133)
...
| **Cache File** | `chain_data_cache_path` | `mmcif_data_cache_path` |
| **Cache Structure** | `{chain_id: metadata}` | `{pdb_id: {chain_ids, seqs, ...}}` |
| **Template Search** | HHSearch | HMMSearch |
| **Identifier** | `{pdb_id}_{chain_id}` | `{pdb_id}` |
| **Filtering** | Per-chain cluster size | Per-chain cluster sizes (list) |
| **Min Residues** | No requirement | 200 residues (distillation only) |

**Sources:** [openfold/data/data_modules.py L26-L290](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/data/data_modules.py#L26-L290)

 [openfold/data/data_modules.py L292-L504](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/data/data_modules.py#L292-L504)
...
[openfold/data/data_modules.py L684-L706](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/data/data_modules.py#L684-L706)

 - `deterministic_train_filter` checks resolution, amino acid composition, and minimum residue count.

[openfold/data/data_modules.py L707-L719](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/data/data_modules.py#L707-L719)

 - `get_stochastic_train_filter_prob` returns a list of probabilities, one per chain, based on cluster sizes.

[openfold/data/data_modules.py L737-L741](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/data/data_modules.py#L737-L741)

 - Extends weights list with one entry per chain rather than one per complex.

**Sources:** [openfold/data/data_modules.py L664-L754](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/data/data_modules.py#L664-L754)
...
**Sources:** [openfold/utils/multi_chain_permutation.py L430-L512](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/multi_chain_permutation.py#L430-L512)
...
**Sources:** [openfold/utils/multi_chain_permutation.py L111-L164](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/multi_chain_permutation.py#L111-L164)

 [tests/test_permutation.py L60-L78](https://github.com/aqlaboratory/openfold/blob/56da08ec/tests/test_permutation.py#L60-L78)
...
**Sources:** [openfold/utils/multi_chain_permutation.py L35-L62](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/multi_chain_permutation.py#L35-L62)

 [openfold/utils/multi_chain_permutation.py L64-L108](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/multi_chain_permutation.py#L64-L108)
...
**Sources:** [openfold/utils/multi_chain_permutation.py L167-L228](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/multi_chain_permutation.py#L167-L228)
...
**Sources:** [train_openfold.py L109-L112](https://github.com/aqlaboratory/openfold/blob/56da08ec/train_openfold.py#L109-L112)
 ...
 [openfold/utils/multi_chain_permutation.py L515-L542](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/multi_chain_permutation.py#L515-L542)
...
**Sources:** [openfold/utils/multi_chain_permutation.py L249-L286](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/multi_chain_permutation.py#L249-L286)

 [tests/test_permutation.py L175-L254](https://github.com/aqlaboratory/openfold/blob/56da08ec/tests/test_permutation.py#L175-L254)

---

## Inter-Chain Feature Pairing

### Asymmetric ID (asym_id)
...
**Sources:** [openfold/utils/loss.py L291-L312](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/loss.py#L291-L312)
...
**Sources:** [openfold/utils/multi_chain_permutation.py L336-L353](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/multi_chain_permutation.py#L336-L353)
...
**Sources:** [tests/test_permutation.py L54-L58](https://github.com/aqlaboratory/openfold/blob/56da08ec/tests/test_permutation.py#L54-L58)
...
**Implementation:** [openfold/utils/loss.py L291-L312](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/loss.py#L291-L312)
...
**Sources:** [openfold/utils/loss.py L286-L325](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/loss.py#L286-L325)
...
**Implementation:** [openfold/utils/loss.py L670-L719](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/loss.py#L670-L719)
...
**Sources:** [openfold/utils/loss.py L670-L719](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/loss.py#L670-L719)
...
**Implementation:** [openfold/utils/loss.py L1022-L1034](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/loss.py#L1022-L1034)

**Sources:** [openfold/utils/loss.py L942-L1094](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/loss.py#L942-L1094)
...
**Sources:** [train_openfold.py L97-L122](https://github.com/aqlaboratory/openfold/blob/56da08ec/train_openfold.py#L97-L122)
 ...
 [openfold/utils/loss.py L286-L326](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/loss.py#L286-L326)
...
| --- | --- | --- |
| `OpenFoldSingleMultimerDataset` | Load multi-chain complexes | `__getitem__()`, `_parse_mmcif()` |
| `OpenFoldMultimerDataset` | Stochastic filtering for multimers | `deterministic_train_filter()`, `looped_samples()` |
| `OpenFoldMultimerDataModule` | PyTorch Lightning data module | `setup()`, `train_dataloader()` |

### Permutation Functions

| Function | Purpose | Location |
| --- | --- | --- |
| `multi_chain_permutation_align()` | Main entry point | [multi_chain_permutation.py L515-L542](https://github.com/aqlaboratory/openfold/blob/56da08ec/multi_chain_permutation.py#L515-L542) |
| `compute_permutation_alignment()` | Compute optimal permutation | [multi_chain_permutation.py L430-L512](https://github.com/aqlaboratory/openfold/blob/56da08ec/multi_chain_permutation.py#L430-L512) |
| `get_least_asym_entity_or_longest_length()` | Select anchor chain | [multi_chain_permutation.py L111-L164](https://github.com/aqlaboratory/openfold/blob/56da08ec/multi_chain_permutation.py#L111-L164) |
| `get_optimal_transform()` | Kabsch alignment | [multi_chain_permutation.py L64-L108](https://github.com/aqlaboratory/openfold/blob/56da08ec/multi_chain_permutation.py#L64-L108) |
| `greedy_align()` | Greedy chain matching | [multi_chain_permutation.py L167-L228](https://github.com/aqlaboratory/openfold/blob/56da08ec/multi_chain_permutation.py#L167-L228) |
| `merge_labels()` | Reorder ground truth | [multi_chain_permutation.py L249-L286](https://github.com/aqlaboratory/openfold/blob/56da08ec/multi_chain_permutation.py#L249-L286) |

### Loss Functions

| Function | Purpose | Multimer-Specific |
| --- | --- | --- |
| `fape_loss()` | FAPE with chain separation | Lines 291-312 check `asym_id` |
| `compute_tm()` | pTM/ipTM calculation | `interface=True` for ipTM |
| `between_residue_clash_loss()` | Clash detection | Lines 1024-1025 respect chain boundaries |

**Sources:** [openfold/data/data_modules.py L1-L1133](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/data/data_modules.py#L1-L1133)

 [openfold/utils/multi_chain_permutation.py L1-L543](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/multi_chain_permutation.py#L1-L543)

 [openfold/utils/loss.py L1-L1304](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/loss.py#L1-L1304)