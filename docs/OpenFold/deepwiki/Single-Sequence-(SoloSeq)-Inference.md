...
For standard MSA-based inference on single chains, see [Monomer Inference](/aqlaboratory/openfold/3.2-monomer-inference). For multi-chain predictions, see [Multimer Inference](/aqlaboratory/openfold/3.3-multimer-inference). For general inference pipeline concepts, see [Inference Pipeline Overview](/aqlaboratory/openfold/3.1-inference-pipeline-overview).

**Sources:** [docs/source/Single_Sequence_Inference.md L1-L57](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Single_Sequence_Inference.md?plain=1#L1-L57)

 [docs/source/Inference.md L7-L13](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Inference.md?plain=1#L7-L13)
...
**Sources:** [docs/source/Single_Sequence_Inference.md L1-L3](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Single_Sequence_Inference.md?plain=1#L1-L3)
...
**Sources:** [docs/source/Single_Sequence_Inference.md L1-L7](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Single_Sequence_Inference.md?plain=1#L1-L7)
...
**Sources:** [docs/source/Single_Sequence_Inference.md L3-L57](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Single_Sequence_Inference.md?plain=1#L3-L57)
...
**Sources:** [docs/source/Single_Sequence_Inference.md L5-L49](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Single_Sequence_Inference.md?plain=1#L5-L49)
...
| --- | --- | --- | --- |
| `seq_model_esm1b_ptm.pt` | `seq_model_esm1b_ptm` | Yes (optional) | Yes |
...
**Sources:** [docs/source/Single_Sequence_Inference.md L15-L51](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Single_Sequence_Inference.md?plain=1#L15-L51)
...
**Sources:** [docs/source/Single_Sequence_Inference.md L7-L32](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Single_Sequence_Inference.md?plain=1#L7-L32)

 [scripts/precompute_embeddings.py L1](https://github.com/aqlaboratory/openfold/blob/56da08ec/scripts/precompute_embeddings.py#L1-L1)
...
**Sources:** [docs/source/Single_Sequence_Inference.md L34-L51](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Single_Sequence_Inference.md?plain=1#L34-L51)
...
| --- | --- | --- |
| `input_embedder.use_esm_embeddings` | `True` | Enable ESM-1b embedding input |
| `model.predicted_tm.enabled` | `True` | Compute pTM confidence score |
| `data.common.use_templates` | `True/False` | Template usage (configurable) |
| `globals.max_recycling_iters` | `3` | Number of recycling iterations |

The configuration is defined in [openfold/config.py](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py)
...
| --- | --- | --- |
| `--skip_relaxation` | Skip AMBER energy minimization | Use for faster results |
| `--save_outputs` | Save all model outputs (MSA track, etc.) | Use for debugging |
| `--cif_output` | Generate MMCIF format output | Use for better metadata |
| `--use_deepspeed_inference` | Use DeepSpeed attention kernels | Use for speed (if available) |
| `--use_flash_attn` | Use FlashAttention kernels | Use for sequences < 1000 residues |
| `--trace_model` | Trace model for faster batch inference | Use for large-scale runs |

**Sources:** [docs/source/Single_Sequence_Inference.md L53-L54](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Single_Sequence_Inference.md?plain=1#L53-L54)

 [docs/source/Inference.md L135-L180](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Inference.md?plain=1#L135-L180)
...
**Sources:** [docs/source/Single_Sequence_Inference.md L1-L57](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Single_Sequence_Inference.md?plain=1#L1-L57)
 ...
 [run_pretrained_openfold.py L1](https://github.com/aqlaboratory/openfold/blob/56da08ec/run_pretrained_openfold.py#L1-L1)
...
**Sources:** [docs/source/Single_Sequence_Inference.md L55-L57](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Single_Sequence_Inference.md?plain=1#L55-L57)
...
**Sources:** [docs/source/Inference.md L123-L129](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Inference.md?plain=1#L123-L129)

---

## Performance Optimization

SoloSeq inference supports all standard OpenFold optimizations. See [Performance Optimization](/aqlaboratory/openfold/3.6-performance-optimization) for detailed guidance.
...
**Sources:** [docs/source/Inference.md L145-L180](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Inference.md?plain=1#L145-L180)

 [docs/source/Single_Sequence_Inference.md L53-L54](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Single_Sequence_Inference.md?plain=1#L53-L54)
...
* **Standard inference workflows**: [Monomer Inference](/aqlaboratory/openfold/3.2-monomer-inference), [Multimer Inference](/aqlaboratory/openfold/3.3-multimer-inference)
* **General inference concepts**: [Inference Pipeline Overview](/aqlaboratory/openfold/3.1-inference-pipeline-overview)
* **Performance tuning**: [Performance Optimization](/aqlaboratory/openfold/3.6-performance-optimization)
* **Model architecture**: [AlphaFold Model Overview](/aqlaboratory/openfold/5.2-alphafold-model-overview)
* **Training with ESM embeddings**: [Training Pipeline](/aqlaboratory/openfold/4.1-training-pipeline)
