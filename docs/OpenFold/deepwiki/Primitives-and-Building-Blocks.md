...
**Sources:** [openfold/model/primitives.py L1-L936](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L1-L936)

 [openfold/model/msa.py L1-L503](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/msa.py#L1-L503)
...
| --- | --- | --- | --- |
| `"default"` | `lecun_normal_init_` | General purpose (LeCun fan-in) | `1.0 / fan_in` |
| `"relu"` | `he_normal_init_` | After ReLU activations | `2.0 / fan_in` |
| `"glorot"` | `glorot_uniform_init_` | Query/Key/Value projections | `1.0 / fan_avg` |
| `"gating"` | `gating_init_` | Gating mechanisms | Weights=0, Bias=1 |
| `"final"` | `final_init_` | Output projections | Weights=0, Bias=0 |
| `"normal"` | `normal_init_` | Alternative general init | Kaiming normal |

All truncated normal initializations use bounds `a=-2, b=2` following AlphaFold's specification.

**Sources:** [openfold/model/primitives.py L138-L227](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L138-L227)

 [openfold/model/primitives.py L92-L135](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L92-L135)
...
INPUT --> CHECK_PREC
CHECK_PREC --> CAST_PREC
CHECK_PREC --> CHECK_BF16
CHECK_BF16 --> CAST_BF16
CHECK_BF16 --> STANDARD
CAST_PREC --> OUTPUT
CAST_BF16 --> OUTPUT
STANDARD --> OUTPUT
...
**Sources:** [openfold/model/primitives.py L208-L226](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L208-L226)
...
**Sources:** [openfold/model/primitives.py L229-L263](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L229-L263)
...
**Sources:** [openfold/model/primitives.py L266-L283](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L266-L283)
...
**Sources:** [openfold/model/primitives.py L360-L587](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L360-L587)
...
| --- | --- | --- | --- |
| `use_memory_efficient_kernel` | `attention_core` | Custom CUDA extension | Default efficient attention |
| `use_deepspeed_evo_attention` | `DS4Sci_EvoformerAttention` | DeepSpeed4Science | Evoformer-optimized attention |
| `use_cuequivariance_attention` | `triangle_attention` | cuEquivariance package | Triangle attention operations |
| `use_flash` | FlashAttention | flash_attn package | Fast attention without bias |
| `use_lma` | `_lma` | None | Long sequences (memory-limited) |
...
**Sources:** [openfold/model/primitives.py L468-L587](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L468-L587)
...
**Sources:** [openfold/model/primitives.py L286-L302](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L286-L302)
...
**Sources:** [openfold/model/primitives.py L590-L676](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L590-L676)
...
The custom CUDA kernel `attention_core` from [openfold/utils/kernel/attention_core.py](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/kernel/attention_core.py)

 provides memory-efficient attention computation. It supports up to 2 bias terms and is disabled when fp16 autocast is enabled.
...
**Sources:** [openfold/model/primitives.py L557-L564](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L557-L564)
...
CHECK_DIMS --> RESHAPE
RESHAPE --> CHECK_DTYPE
CHECK_DIMS --> NO_RESHAPE
NO_RESHAPE --> CHECK_DTYPE
CHECK_DTYPE --> CAST_BF16
CAST_BF16 --> DS4SCI
CHECK_DTYPE --> NO_CAST
NO_CAST --> DS4SCI
DS4SCI --> RESTORE
...
**Sources:** [openfold/model/primitives.py L679-L742](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L679-L742)
...
**Sources:** [openfold/model/primitives.py L745-L804](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L745-L804)
...
**Sources:** [openfold/model/primitives.py L807-L870](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L807-L870)
...
**Sources:** [openfold/model/primitives.py L873-L935](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L873-L935)

 [openfold/model/primitives.py L37-L55](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L37-L55)
...
**Sources:** [openfold/model/msa.py L1-L503](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/msa.py#L1-L503)
...
1. **Pair Bias Integration**: Optionally incorporates pair representation z into attention bias ```markdown # When pair_bias=Truez_bias = linear_z(layer_norm_z(z))  # [*, N_res, N_res, no_heads]z_bias = z_bias.permute(...).unsqueeze(-4)  # [*, 1, no_heads, N_res, N_res] ```
2. **Mask Handling**: Converts masks to attention bias ```markdown mask_bias = inf * (mask - 1)  # [*, N_seq, 1, 1, N_res] ```
...
**Sources:** [openfold/model/msa.py L38-L316](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/msa.py#L38-L316)
...
**Sources:** [openfold/model/msa.py L319-L346](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/msa.py#L319-L346)
...
**Sources:** [openfold/model/msa.py L348-L424](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/msa.py#L348-L424)
...
**Sources:** [openfold/model/msa.py L427-L502](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/msa.py#L427-L502)
...
**Sources:** [openfold/model/primitives.py L92-L135](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L92-L135)
...
| IPA point attention weights | `ipa_point_weights_init_` | Softplus pre-activation |
...
**Sources:** [openfold/model/primitives.py L138-L205](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L138-L205)
...
| `attention_core` | Medium | Fast | 2 biases | Custom CUDA extension |
| DeepSpeed | Low | Fast | 2 biases | DeepSpeed4Science, bf16/fp16 |
| FlashAttention | Very Low | Very Fast | None (masks only) | flash_attn package |
...
**Sources:** [openfold/model/primitives.py L208-L226](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L208-L226)
 ...
 [openfold/model/primitives.py L239-L263](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L239-L263)

 [openfold/model/primitives.py L729-L739](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L729-L739)
...
**Sources:** [openfold/model/evoformer.py](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/evoformer.py)
 ...
 [openfold/model/embedders.py](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/embedders.py)
