...
For information about the Structure Module that transforms the Evoformer outputs into 3D coordinates, see [Structure Module](/aqlaboratory/openfold/5.2-alphafold-model-overview).
...
* [openfold/model/evoformer.py L124-L134](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/evoformer.py#L124-L134)
* [openfold/model/model.py L416-L434](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/model.py#L416-L434)
...
* [openfold/model/model.py L123-L134](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/model.py#L123-L134)
...
| --- | --- | --- |
| `c_m` | MSA channel dimension | 256 |
| `c_z` | Pair channel dimension | 128 |
| `c_s` | Single representation dimension | 384 |
| `no_heads_msa` | Number of MSA attention heads | 8 |
| `no_heads_pair` | Number of pair attention heads | 4 |
| `no_blocks` | Number of Evoformer blocks | 48 |
| `transition_n` | Multiplier for transition hidden dimension | 4 |
| `blocks_per_ckpt` | Number of blocks per activation checkpoint | Varies |
| `clear_cache_between_blocks` | Whether to clear attention cache | False |

Sources:

* [openfold/config.py L590-L611](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L590-L611)
* [openfold/model/evoformer.py L257-L264](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/evoformer.py#L257-L264)
...
* [openfold/model/evoformer.py L397-L552](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/evoformer.py#L397-L552)
...
* [openfold/model/evoformer.py L423-L552](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/evoformer.py#L423-L552)
* [openfold/model/evoformer.py L123-L267](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/evoformer.py#L123-L267)
...
* [openfold/model/msa.py L295-L321](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/msa.py#L295-L321)
* [openfold/model/primitives.py L340-L547](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L340-L547)
...
* [openfold/model/msa.py L324-L397](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/msa.py#L324-L397)
...
* [openfold/model/evoformer.py L48-L120](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/evoformer.py#L48-L120)
...
* [openfold/model/triangular_multiplicative_update.py](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/triangular_multiplicative_update.py)
...
* [openfold/model/triangular_attention.py L31-L164](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/triangular_attention.py#L31-L164)
...
* [openfold/model/pair_transition.py L24-L99](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/pair_transition.py#L24-L99)
...
* [openfold/model/evoformer.py L248-L264](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/evoformer.py#L248-L264)
...
* [openfold/model/triangular_attention.py L60-L147](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/triangular_attention.py#L60-L147)
...
* [openfold/model/evoformer.py L590-L607](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/evoformer.py#L590-L607)
...
* [openfold/model/primitives.py L477-L545](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py#L477-L545)
* [openfold/config.py L465-L486](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L465-L486)
...
* [openfold/model/model.py L65-L461](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/model.py#L65-L461)
...
* [openfold/model/model.py L209-L476](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/model.py#L209-L476)
...
* [openfold/model/evoformer.py L413-L421](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/evoformer.py#L413-L421)
* [openfold/config.py L924-L954](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L924-L954)
...
* [openfold/config.py L193-L227](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L193-L227)
* [openfold/model/model.py L136-L153](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/model.py#L136-L153)
