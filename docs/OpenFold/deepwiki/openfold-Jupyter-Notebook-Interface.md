...
owner: aqlaboratory
repo: openfold
url: https://deepwiki.com/aqlaboratory/openfold/3.5-jupyter-notebook-interface
---
...
> - [scripts/download\_openfold\_params\_huggingface\.sh](https://github.com/aqlaboratory/openfold/blob/56da08ec/scripts/download_openfold_params_huggingface.sh)
 ...
 The OpenFold Jupyter Notebook interface provides an interactive way to run protein structure predictions using OpenFold's PyTorch implementation, without requiring extensive command\-line knowledge\. This interface is particularly useful for quick predictions, visualization, and experimentation with different model configurations\. For command\-line inference options, see [Monomer Inference](https://deepwiki.com/aqlaboratory/openfold/3.1-inference-pipeline-overview), [Multimer Inference](https://deepwiki.com/aqlaboratory/openfold/3.2-monomer-inference), or [Single Sequence Inference](https://deepwiki.com/aqlaboratory/openfold/3.3-multimer-inference)\.
...
```
 ...
 Sources: [OpenFold\.ipynb L2-L133](https://github.com/aqlaboratory/openfold/blob/56da08ec/notebooks/OpenFold.ipynb#L2-L133)
...
- Visualization libraries \(py3Dmol\)
 ...
 Sources: [OpenFold\.ipynb L88-L137](https://github.com/aqlaboratory/openfold/blob/56da08ec/notebooks/OpenFold.ipynb#L88-L137) [environment\.yml L1-L18](https://github.com/aqlaboratory/openfold/blob/56da08ec/notebooks/environment.yml#L1-L18)
...
| --- | --- | --- |
| input\_sequence | Amino acid sequence\(s\) to fold | Single sequence or multiple sequences separated by colons \(:\) |
| weight\_set | Parameter weights to use | "OpenFold" or "AlphaFold" |
| model\_mode | Prediction mode | "monomer" or "multimer" |
| relax\_prediction | Whether to apply AMBER relaxation | True/False |

 Sources: [OpenFold\.ipynb L42-L84](https://github.com/aqlaboratory/openfold/blob/56da08ec/notebooks/OpenFold.ipynb#L42-L84)
...
```
 ...
 Sources: [OpenFold\.ipynb L274-L433](https://github.com/aqlaboratory/openfold/blob/56da08ec/notebooks/OpenFold.ipynb#L274-L433) [OpenFold\.ipynb L441-L798](https://github.com/aqlaboratory/openfold/blob/56da08ec/notebooks/OpenFold.ipynb#L441-L798)
...
### 1\. Environment Setup
 ...
 Sources: [OpenFold\.ipynb L88-L186](https://github.com/aqlaboratory/openfold/blob/56da08ec/notebooks/OpenFold.ipynb#L88-L186) [download\_openfold\_params\_gdrive\.sh L1-L68](https://github.com/aqlaboratory/openfold/blob/56da08ec/scripts/download_openfold_params_gdrive.sh#L1-L68) [download\_openfold\_params\_huggingface\.sh L1-L33](https://github.com/aqlaboratory/openfold/blob/56da08ec/scripts/download_openfold_params_huggingface.sh#L1-L33)
...
- UniProt \(only for multimer heteromer predictions\)
 ...
 Sources: [OpenFold\.ipynb L274-L427](https://github.com/aqlaboratory/openfold/blob/56da08ec/notebooks/OpenFold.ipynb#L274-L427)
...
- **AlphaFold weights**: Original weights from DeepMind, converted for use in OpenFold
 ...
 Sources: [OpenFold\.ipynb L441-L664](https://github.com/aqlaboratory/openfold/blob/56da08ec/notebooks/OpenFold.ipynb#L441-L664)
...
```
 ...
 Sources: [OpenFold\.ipynb L666-L797](https://github.com/aqlaboratory/openfold/blob/56da08ec/notebooks/OpenFold.ipynb#L666-L797)
...
2. **OpenFold weights** \(`weight_set = 'OpenFold'`\):  - Parameters trained in the PyTorch implementation - Currently only supports monomer prediction - Downloaded from AWS S3 or HuggingFace
 ...
 Sources: [OpenFold\.ipynb L154-L185](https://github.com/aqlaboratory/openfold/blob/56da08ec/notebooks/OpenFold.ipynb#L154-L185)

### Model Modes

 Two model modes are available:

 1. **Monomer mode** \(`model_mode = 'monomer'`\):  - For single protein chains - Uses models: finetuning\_3\-5\.pt, finetuning\_ptm\_2\.pt, finetuning\_no\_templ\_ptm\_1\.pt \(OpenFold weights\) or model\_1\-5 \(AlphaFold weights\)
2. **Multimer mode** \(`model_mode = 'multimer'`\):  - For protein complexes with multiple chains - Uses model\_1\-5\_multimer\_v3 \(AlphaFold weights only\) - Requires sequences separated by colons in the input

 Sources: [OpenFold\.ipynb L53-L82](https://github.com/aqlaboratory/openfold/blob/56da08ec/notebooks/OpenFold.ipynb#L53-L82) [OpenFold\.ipynb L461-L471](https://github.com/aqlaboratory/openfold/blob/56da08ec/notebooks/OpenFold.ipynb#L461-L471)
...
5. For very large proteins or complexes, the notebook may run out of memory
 ...
 Sources: [OpenFold\.ipynb L10-L38](https://github.com/aqlaboratory/openfold/blob/56da08ec/notebooks/OpenFold.ipynb#L10-L38)
...
6. Download the results for further analysis
 ...
 Sources: [OpenFold\.ipynb L267-L271](https://github.com/aqlaboratory/openfold/blob/56da08ec/notebooks/OpenFold.ipynb#L267-L271) [OpenFold\.ipynb L663-L797](https://github.com/aqlaboratory/openfold/blob/56da08ec/notebooks/OpenFold.ipynb#L663-L797)

---
*Source: [https://deepwiki.com/aqlaboratory/openfold/3.5-jupyter-notebook-interface](https://deepwiki.com/aqlaboratory/openfold/3.5-jupyter-notebook-interface) on DeepWiki*