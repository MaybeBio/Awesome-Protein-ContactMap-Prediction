...
owner: aqlaboratory
repo: openfold
url: https://deepwiki.com/aqlaboratory/openfold/3.6-performance-optimization
---
...
> - [openfold/model/evoformer\.py](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/evoformer.py)
 ...
 For information about the overall inference workflow, see [Inference Pipeline Overview](https://deepwiki.com/aqlaboratory/openfold/3.1-inference-pipeline-overview)\. For training\-specific optimizations, see [Memory Optimization for Training](https://deepwiki.com/aqlaboratory/openfold/4.3-memory-optimization-for-training)\.
 ...
 **Optimization Strategy Decision Tree**
 ...
 Sources: [Inference\.md?plain=1 L144-L194](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Inference.md?plain=1#L144-L194) [config\.py L85-L304](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L85-L304)
...
- Config field: `config.precision = "tf32"`
 ...
 Sources: [Inference\.md?plain=1 L146-L156](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Inference.md?plain=1#L146-L156) [config\.py L93-L101](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L93-L101)
...
- Low precision epsilon: Set automatically when `low_prec=True` in [config\.py L296-L300](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L296-L300)
...
| FP16 | 1 | 5 | 10 | ~1\.5x | 2 bytes | Not recommended \(unstable\) |
 ...
 Sources: [Inference\.md?plain=1 L158-L163](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Inference.md?plain=1#L158-L163) [config\.py L88-L300](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L88-L300)
...
subgraph subGraph0 ["Attention Kernel Selection"]
    ...
    DEFAULT_K
    INPUT --> CHECK
    CHECK -->|"DeepSpeed enabled"| DS
    CHECK -->|"FlashAttention enabled"| FLASH
    CHECK -->|"cuEquivariance enabled"| CUEQ
    CHECK -->|"LMA enabled"| LMA_K
    CHECK -->|"None enabled"| DEFAULT_K
end
```

 **Kernel Selection in Code**

 Sources: [config\.py L39-L534](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L39-L534)

### DeepSpeed DS4Sci EvoformerAttention

 The DeepSpeed DS4Sci\_EvoformerAttention kernel is a memory\-efficient attention implementation developed through the OpenFold\-DeepSpeed4Science collaboration\. It provides 2\-3x speedup without significant additional memory overhead\.
...
- Checked at runtime in [config\.py L65-L72](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L65-L72)

 **Usage in Evoformer:**

 The kernel is passed through the forward call chain:

 - [evoformer\.py L439-L740](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/evoformer.py#L439-L740) \- `use_deepspeed_evo_attention` parameter
- Applied in MSARowAttention, TriangleAttention modules

 Sources: [Inference\.md?plain=1 L164-L169](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Inference.md?plain=1#L164-L169) [config\.py L65-L522](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L65-L522) [evoformer\.py L184-L374](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/evoformer.py#L184-L374)
...
- Verified at [config\.py L61-L63](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L61-L63)

 **Limitations:**

 - Not recommended for sequences \>1000 residues
- Disabled automatically in `long_sequence_inference` mode [config\.py L273](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L273-L273)
- Mutually exclusive with DeepSpeed and LMA

 Sources: [Inference\.md?plain=1 L173](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Inference.md?plain=1#L173-L173) [config\.py L61-L529](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L61-L529)
...
- Validated at [config\.py L74-L76](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L74-L76)
...
- `triangle_multiplicative_update` \- Used in TriangleMultiplication modules
 ...
 Sources: [Inference\.md?plain=1 L170-L172](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Inference.md?plain=1#L170-L172) [config\.py L74-L534](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L74-L534) [evoformer\.py L186-L741](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/evoformer.py#L186-L741)
...
- Key chunk: 4096
 ...
 These can be modified in [openfold/model/primitives\.py](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/primitives.py) for advanced users\.
...
- Automatically enabled by `long_sequence_inference` flag
 ...
 Sources: [Inference\.md?plain=1 L188](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Inference.md?plain=1#L188-L188) [config\.py L272-L525](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L272-L525)
...
subgraph subGraph0 ["Kernel Constraints"]
    ...
    GROUP1 --> FLASH
    GROUP1 --> DEEPSPEED
    GROUP2 -->|"Can combine"| CUEQ_A
    GROUP3 -->|"Falls back to"| CUEQ_M
    DEEPSPEED -->|"Can combine"| CUEQ_A
    CUEQ_A -->|"Falls back to"| DEEPSPEED
end
```

 **Kernel Compatibility Matrix**

| Kernel | use\_lma | use\_flash | use\_deepspeed | use\_cueq\_attn | use\_cueq\_mult |
| --- | --- | --- | --- | --- | --- |
| use\_lma | ✓ | ✗ | ✗ | ✗ | ✓ |
| use\_flash | ✗ | ✓ | ✗ | ✗ | ✓ |
| use\_deepspeed | ✗ | ✗ | ✓ | ✓ | ✓ |
...
| use\_cueq\_mult | ✓ | ✓ | ✓ | ✓ | ✓ |
 ...
 Enforcement in [config\.py L39-L59](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L39-L59)

 Sources: [config\.py L39-L76](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L39-L76)
...
| --- | --- | --- |
| \-\-trt\_mode | None | Set to "run" to enable TensorRT |
| \-\-trt\_engine\_dir | None | Directory to store compiled engines |
| \-\-trt\_num\_profiles | 1 | Number of optimization profiles |
| \-\-trt\_optimization\_level | 3 | TensorRT optimization level \(0\-5\) |
| \-\-trt\_max\_sequence\_len | 640 | Maximum sequence length for optimization |

 **Configuration in Code:**

 Set in [config\.py L94-L99](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L94-L99):
...
- Can be combined with cuEquivariance for additional speedup
 ...
 Sources: [Inference\.md?plain=1 L176](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Inference.md?plain=1#L176-L176) [config\.py L94-L340](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L94-L340)
...
- Model must run with fixed input shapes during tracing
 ...
 Sources: [Inference\.md?plain=1 L178-L179](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Inference.md?plain=1#L178-L179)
 ...
 **Long Sequence Mode Configuration**
 ...
 Sources: [config\.py L268-L277](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L268-L277)
...
- `*.tune_chunk_size = False`
 ...
 Implementation in [config\.py L268-L277](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L268-L277)

 Sources: [Inference\.md?plain=1 L184-L193](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Inference.md?plain=1#L184-L193) [config\.py L268-L277](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L268-L277)
 ...
 **Automatic Enforcement:**
 ...
 If `offload_inference` is enabled and `average_templates` is false, the system automatically sets `offload_templates = True` in [config\.py L78-L82](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L78-L82)

 **Mutual Exclusivity:**

 Enforced in [config\.py L39-L43](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L39-L43) \- only one can be enabled at a time\.

 Sources: [Inference\.md?plain=1 L187](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Inference.md?plain=1#L187-L187) [config\.py L39-L617](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L39-L617)
...
```
 ...
 The ChunkSizeTuner starts with a minimum chunk size \(from config\) and dynamically adjusts based on available memory\. Implementation in [evoformer\.py L878-L881](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/evoformer.py#L878-L881):
...
```
 ...
 Automatically configured in long sequence mode at [config\.py L275-L277](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L275-L277)
...
```
 ...
 Sources: [Inference\.md?plain=1 L181-L189](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Inference.md?plain=1#L181-L189) [config\.py L275-L324](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L275-L324) [evoformer\.py L878-L881](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/evoformer.py#L878-L881)
 ...
 **Offload Points:**
 ...
 Implemented in [evoformer\.py L344-L730](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/evoformer.py#L344-L730):
 ...
 **Memory Results:**
 ...
 Sources: [Inference\.md?plain=1 L190-L193](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Inference.md?plain=1#L190-L193) [config\.py L270-L535](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L270-L535) [evoformer\.py L344-L495](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/model/evoformer.py#L344-L495)
...
| \-\-use\_deepspeed\_inference | DeepSpeed attention kernel | 2\-3x | Minimal |
| \-\-use\_cuequivariance\_attention | cuEquivariance triangle attention | \+1\.2\-1\.5x | Reduced |
| \-\-use\_cuequivariance\_multiplicative\_update | cuEquivariance triangle mult | \+1\.2\-1\.5x | None |
| \-\-trt\_mode=run | TensorRT compilation | Varies | None |
| \-\-trace\_model | PyTorch JIT tracing | Significant \(batch\) | None |
| \-\-long\_sequence\_inference | All long\-sequence strategies | Varies | Greatly reduced |
...
### Config Dict Settings
 ...
 For programmatic configuration, key settings are located in [config\.py L516-L544](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L516-L544):
...
```
 ...
 Template settings in [config\.py L604-L617](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L604-L617):

```
"template": {    "average_templates": False,    "offload_templates": False,}
```

 Sources: [config\.py L85-L798](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/config.py#L85-L798) [Inference\.md?plain=1 L144-L194](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Inference.md?plain=1#L144-L194)

---
*Source: [https://deepwiki.com/aqlaboratory/openfold/3.6-performance-optimization](https://deepwiki.com/aqlaboratory/openfold/3.6-performance-optimization) on DeepWiki*