...
owner: aqlaboratory
repo: openfold
url: https://deepwiki.com/aqlaboratory/openfold/7-protein-representations
---
...
```
 ...
 Sources: [protein\.py L45-L86](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/np/protein.py#L45-L86)
...
## The Core Protein Data Structure
 ...
 - **atom\_positions**: 3D coordinates of each atom in angstroms \[num\_res, num\_atom\_type, 3\]
- **aatype**: Amino acid type for each residue, represented as integers between 0 and 20, where 20 is 'X' \(unknown\) \[num\_res\]
- **atom\_mask**: Binary mask indicating the presence of each atom \(1\.0 if present, 0\.0 if not\) \[num\_res, num\_atom\_type\]
- **residue\_index**: Residue indices as used in PDB \(not necessarily continuous or 0\-indexed\) \[num\_res\]
- **b\_factors**: Temperature factors for each atom, representing displacement from mean position \[num\_res, num\_atom\_type\]
- **chain\_index**: Indices for multi\-chain predictions \[num\_res\]
...
- **parents\_chain\_index**: Chain corresponding to each parent
...
subgraph subGraph0 ["Amino Acid Encoding"]
    ...
    AAidx
    AA1 --> AA3
    AA3 -->|"restype_3to1"| AA1
    AA1 -->|"restype_order"| AAidx
    AAidx --> AA1
end
```
...
| 20 | X | UNK |
 ...
 Sources: [residue\_constants\.py L854-L879](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/np/residue_constants.py#L854-L879)
...
- O: Backbone oxygen
 ...
 Sources: [residue\_constants\.py L556-L596](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/np/residue_constants.py#L556-L596)
...
PDB -->|"from_pdb_string()"| P
PN -->|"from_proteinnet_string()"| P
MP -->|"from_prediction()"| P
P -->|"to_pdb()"| OPDB
P -->|"to_modelcif()"| OCIF
...
- Chain information
 ...
 Sources: [protein\.py L89-L185](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/np/protein.py#L89-L185)
...
### Creation from ProteinNet
 ...
 Sources: [protein\.py L188-L238](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/np/protein.py#L188-L238)
...
```
 ...
 Sources: [protein\.py L590-L636](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/np/protein.py#L590-L636)
...
- Adds remarks and parent template information
 ...
 Sources: [protein\.py L321-L443](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/np/protein.py#L321-L443)
...
- Handles multiple polymer entities
 ...
 Sources: [protein\.py L446-L571](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/np/protein.py#L446-L571)
...
6. Convert to a `Protein` object when needed
 ...
 Sources: [mmcif\_parsing\.py L78-L502](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/data/mmcif_parsing.py#L78-L502)
...
- Corrects naming errors in certain residues \(e\.g\., arginine NH1/NH2\)
 ...
 Sources: [mmcif\_parsing\.py L435-L502](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/data/mmcif_parsing.py#L435-L502)
...
5. Return either a PDB or ModelCIF string
 ...
 Sources: [relax\.py L23-L99](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/np/relax/relax.py#L23-L99) [script\_utils\.py L232-L262](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/script_utils.py#L232-L262)
...
```
 ...
 Sources: [script\_utils\.py L150-L230](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/utils/script_utils.py#L150-L230)
...
- Setting up the structural modules in the neural network
 ...
 Sources: [residue\_constants\.py L355-L404](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/np/residue_constants.py#L355-L404)
...
FASTA -->|"Sequence Input"| OF
A3M -->|"MSA Input"| OF
OF -->|"Structure Prediction"| PDB
OF --> ModelCIF
PDB -->|"Structure Prediction"| OF
mmCIF --> OF
ProteinNet --> OF
...
```
 ...
 Sources: [jackhmmer\.py L31-L258](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/data/tools/jackhmmer.py#L31-L258) [hhsearch\.py L27-L126](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/data/tools/hhsearch.py#L27-L126) [unpack\_proteinnet\.py L1-L47](https://github.com/aqlaboratory/openfold/blob/56da08ec/scripts/unpack_proteinnet.py#L1-L47)
...
### Ideal Atom Mask
 ...
 Sources: [protein\.py L574-L587](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/np/protein.py#L574-L587)
...
- Handle chain breaks in multi\-chain proteins
 ...
 Sources: [protein\.py L39-L41](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/np/protein.py#L39-L41) [protein\.py L81-L86](https://github.com/aqlaboratory/openfold/blob/56da08ec/openfold/np/protein.py#L81-L86)
...
---
*Source: [https://deepwiki.com/aqlaboratory/openfold/7-protein-representations](https://deepwiki.com/aqlaboratory/openfold/7-protein-representations) on DeepWiki*