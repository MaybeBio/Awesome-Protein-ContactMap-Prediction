...
> * [scripts/download_openfold_params.sh](https://github.com/aqlaboratory/openfold/blob/56da08ec/scripts/download_openfold_params.sh)
> * [scripts/install_third_party_dependencies.sh](https://github.com/aqlaboratory/openfold/blob/56da08ec/scripts/install_third_party_dependencies.sh)
...
For information about running inference after installation, see [Running Inference](/aqlaboratory/openfold/3-running-inference). For training setup, see [Training OpenFold](/aqlaboratory/openfold/4-training-openfold).
...
**Sources**: [environment.yml L1-L41](https://github.com/aqlaboratory/openfold/blob/56da08ec/environment.yml#L1-L41)

 [Dockerfile L1-L39](https://github.com/aqlaboratory/openfold/blob/56da08ec/Dockerfile#L1-L39)

 [setup.py L41-L77](https://github.com/aqlaboratory/openfold/blob/56da08ec/setup.py#L41-L77)
...
**Sources**: [docs/source/Installation.md L14-L39](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Installation.md?plain=1#L14-L39)

 [scripts/install_third_party_dependencies.sh L1-L25](https://github.com/aqlaboratory/openfold/blob/56da08ec/scripts/install_third_party_dependencies.sh#L1-L25)
...
| `scripts/install_third_party_dependencies.sh` | Post-installation setup |
| `scripts/download_*_params.sh` | Parameter download utilities |
| `Dockerfile` | Container-based installation |

**Sources**: [docs/source/Installation.md L15](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Installation.md?plain=1#L15-L15)
...
**Sources**: [environment.yml L1-L41](https://github.com/aqlaboratory/openfold/blob/56da08ec/environment.yml#L1-L41)
 ...
 [docs/source/Installation.md L17-L20](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Installation.md?plain=1#L17-L20)
...
The build system in [setup.py L26-L149](https://github.com/aqlaboratory/openfold/blob/56da08ec/setup.py#L26-L149)
...
| File | Purpose | Lines |
| --- | --- | --- |
| `openfold/utils/kernel/csrc/softmax_cuda.cpp` | C++ interface | [setup.py L91](https://github.com/aqlaboratory/openfold/blob/56da08ec/setup.py#L91-L91) |
| `openfold/utils/kernel/csrc/softmax_cuda_kernel.cu` | CUDA kernel | [setup.py L92](https://github.com/aqlaboratory/openfold/blob/56da08ec/setup.py#L92-L92) |
| `openfold/utils/kernel/csrc/softmax_cuda_stub.cpp` | CPU fallback | [setup.py L114](https://github.com/aqlaboratory/openfold/blob/56da08ec/setup.py#L114-L114) |
...
**Sources**: [setup.py L1-L150](https://github.com/aqlaboratory/openfold/blob/56da08ec/setup.py#L1-L150)

 [scripts/install_third_party_dependencies.sh L14](https://github.com/aqlaboratory/openfold/blob/56da08ec/scripts/install_third_party_dependencies.sh#L14-L14)
...
1. **Downloads folding resources** ([scripts/install_third_party_dependencies.sh L3-L5](https://github.com/aqlaboratory/openfold/blob/56da08ec/scripts/install_third_party_dependencies.sh#L3-L5) ): * `stereo_chemical_props.txt` from OpenStructure * Used for stereochemical constraint validation * Saved to `openfold/resources/`
2. **Prepares test data** ([scripts/install_third_party_dependencies.sh L7-L12](https://github.com/aqlaboratory/openfold/blob/56da08ec/scripts/install_third_party_dependencies.sh#L7-L12) ): * Symlinks stereo props file for tests * Decompresses `sample_feats.pickle.gz`
3. **Compiles CUDA extensions** ([scripts/install_third_party_dependencies.sh L14](https://github.com/aqlaboratory/openfold/blob/56da08ec/scripts/install_third_party_dependencies.sh#L14-L14) ): * Runs `python setup.py install` * Builds `attn_core_inplace_cuda` module
4. **Downloads CUTLASS** ([scripts/install_third_party_dependencies.sh L16-L18](https://github.com/aqlaboratory/openfold/blob/56da08ec/scripts/install_third_party_dependencies.sh#L16-L18) ): * Clones CUTLASS v3.6.0 from NVIDIA * Required for DeepSpeed Evoformer attention kernel * Sets `CUTLASS_PATH` environment variable
5. **Configures runtime** ([scripts/install_third_party_dependencies.sh L20-L24](https://github.com/aqlaboratory/openfold/blob/56da08ec/scripts/install_third_party_dependencies.sh#L20-L24) ): * Sets `KMP_AFFINITY=none` (fixes OpenMP worker assignment) * Exports library paths for conda environment
...
**Sources**: [scripts/install_third_party_dependencies.sh L1-L25](https://github.com/aqlaboratory/openfold/blob/56da08ec/scripts/install_third_party_dependencies.sh#L1-L25)

 [docs/source/Installation.md L21-L30](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Installation.md?plain=1#L21-L30)
...
The AWS download script [scripts/download_openfold_params.sh L1-L35](https://github.com/aqlaboratory/openfold/blob/56da08ec/scripts/download_openfold_params.sh#L1-L35)

 performs validation and download:
...
**Sources**: [scripts/download_openfold_params.sh L1-L35](https://github.com/aqlaboratory/openfold/blob/56da08ec/scripts/download_openfold_params.sh#L1-L35)

 [docs/source/Installation.md L32-L38](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Installation.md?plain=1#L32-L38)
...
| **Kernel Tests** | CUDA extension functionality | attn_core_inplace_cuda compiled |
| **Data Tests** | Feature generation pipeline | Test data in `tests/test_data/` |
...
**Sources**: [docs/source/Installation.md L40-L52](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Installation.md?plain=1#L40-L52)
...
The [setup.py L137-L142](https://github.com/aqlaboratory/openfold/blob/56da08ec/setup.py#L137-L142)

 includes cuEquivariance as an optional extra:
...
See [Performance Optimization](/aqlaboratory/openfold/3.6-performance-optimization) for usage details.

**Sources**: [docs/source/Installation.md L54-L60](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Installation.md?plain=1#L54-L60)

 [setup.py L137-L142](https://github.com/aqlaboratory/openfold/blob/56da08ec/setup.py#L137-L142)
...
The Dockerfile [Dockerfile L1-L39](https://github.com/aqlaboratory/openfold/blob/56da08ec/Dockerfile#L1-L39)
...
* Downloads stereo_chemical_props.txt
...
**Sources**: [Dockerfile L1-L39](https://github.com/aqlaboratory/openfold/blob/56da08ec/Dockerfile#L1-L39)

 [docs/source/Installation.md L68-L70](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Installation.md?plain=1#L68-L70)
...
**Sources**: [scripts/install_third_party_dependencies.sh L1-L25](https://github.com/aqlaboratory/openfold/blob/56da08ec/scripts/install_third_party_dependencies.sh#L1-L25)
 ...
 [Dockerfile L30-L38](https://github.com/aqlaboratory/openfold/blob/56da08ec/Dockerfile#L30-L38)
...
| --- | --- | --- |
| **Import error for attn_core_inplace_cuda** | CUDA extension not compiled | Re-run `python setup.py install` |
| **CUDA version mismatch** | PyTorch CUDA != system CUDA | Ensure `pytorch-cuda` version matches system |
| **Missing CUTLASS_PATH** | Environment variable not set | Run `conda env config vars set CUTLASS_PATH=...` |
...
| **OpenMM import error** | Library path not configured | Export `LD_LIBRARY_PATH` |
...
1. Create a clean environment: ```sql conda deactivateconda env remove -n openfold_envmamba env create -n openfold_env -f environment.yml ```
2. Update mamba itself: ```sql mamba update -n base mamba ```
...
3. Manually specify compute capability in setup.py environment: ```javascript export TORCH_CUDA_ARCH_LIST="8.0;8.6;9.0"python setup.py install ```

**Sources**: [setup.py L41-L119](https://github.com/aqlaboratory/openfold/blob/56da08ec/setup.py#L41-L119)

 [scripts/install_third_party_dependencies.sh L20-L24](https://github.com/aqlaboratory/openfold/blob/56da08ec/scripts/install_third_party_dependencies.sh#L20-L24)
...
* **Inference**: See [Running Inference](/aqlaboratory/openfold/3-running-inference)
* **Training**: See [Training OpenFold](/aqlaboratory/openfold/4-training-openfold)
* **Performance tuning**: See [Performance Optimization](/aqlaboratory/openfold/3.6-performance-optimization)

**Sources**: [docs/source/Installation.md L1-L71](https://github.com/aqlaboratory/openfold/blob/56da08ec/docs/source/Installation.md?plain=1#L1-L71)

 [environment.yml L1-L41](https://github.com/aqlaboratory/openfold/blob/56da08ec/environment.yml#L1-L41)

 [setup.py L1-L150](https://github.com/aqlaboratory/openfold/blob/56da08ec/setup.py#L1-L150)
