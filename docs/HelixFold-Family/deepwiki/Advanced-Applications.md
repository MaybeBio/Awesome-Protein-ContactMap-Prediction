...
The primary focus of this section is on cutting-edge research implementations and prototype systems that demonstrate the versatility of the PaddleHelix platform. For production-ready protein structure prediction, see [Protein Structure Prediction](/PaddlePaddle/PaddleHelix/3.1-protein-structure-prediction). For standard drug discovery workflows, see [Drug Discovery](/PaddlePaddle/PaddleHelix/3.2-drug-discovery).
...
STRUCT["3D Structures"]
TEXT["Text Descriptions"]
ANGLES["Torsion Angles"]
SEQENC["SequenceEncoder"]
STRUCTENC["StructureEncoder"]
RESEMB["ResidueEmbedding"]
SEQABS["sequence_abstractor<br>AbstractorConfig"]
STRUCTABS["structure_abstractor<br>AbstractorConfig"]
LLM["language_model<br>LlamaForCausalLM"]
NUMDEC["number_decoder<br>NumberDecoderConfig"]
TEXTOUT["Generated Text"]
SEQOUT["Generated Sequences"]
STRUCTOUT["Generated Structures"]
ANGLEOUT["Predicted Angles"]
...
subgraph Core_Model ["Core_Model"]
    LLM
    NUMDEC
    LLM --> NUMDEC
end

subgraph Abstraction_Layer ["Abstraction_Layer"]
    SEQABS
    STRUCTABS
end

subgraph Encoder_Layer ["Encoder_Layer"]
    SEQENC
    STRUCTENC
    RESEMB
end

subgraph Input_Modalities ["Input_Modalities"]
    SEQ
    STRUCT
    TEXT
    ANGLES
...
**Sources:** [apps/helixprotx/model_config.py L115-L189](https://github.com/PaddlePaddle/PaddleHelix/blob/7fdd7a18/apps/helixprotx/model_config.py#L115-L189)

 [apps/helixprotx/README.md L1-L39](https://github.com/PaddlePaddle/PaddleHelix/blob/7fdd7a18/apps/helixprotx/README.md?plain=1#L1-L39)
...
RESCONF["residue_embedding_config<br>ResidueEmbeddingConfig"]
MAINCONFIG["HelixProtXConfig<br>model_type: helixprotx"]
STRUCTCONF["structure_abstractor_config<br>AbstractorConfig"]
SEQCONF["sequence_abstractor_config<br>AbstractorConfig"]
NUMCONF["number_decoder_config<br>NumberDecoderConfig"]
TEXTCONF["text_config<br>LlamaConfig"]

subgraph HelixProtXConfig ["HelixProtXConfig"]
    MAINCONFIG
    MAINCONFIG --> STRUCTCONF
    MAINCONFIG --> SEQCONF
    MAINCONFIG --> RESCONF
    MAINCONFIG --> NUMCONF
    MAINCONFIG --> TEXTCONF

subgraph subGraph1 ["Specialized_Configs"]
    RESCONF
    NUMCONF
    TEXTCONF
end

subgraph Abstractor_Configs ["Abstractor_Configs"]
    STRUCTCONF
    SEQCONF
end
end
...
**Sources:** [apps/helixprotx/model_config.py L115-L189](https://github.com/PaddlePaddle/PaddleHelix/blob/7fdd7a18/apps/helixprotx/model_config.py#L115-L189)
 ...
 [apps/helixprotx/model_config.py L26-L58](https://github.com/PaddlePaddle/PaddleHelix/blob/7fdd7a18/apps/helixprotx/model_config.py#L26-L58)
...
**Sources:** [apps/helixprotx/model_config.py L34-L58](https://github.com/PaddlePaddle/PaddleHelix/blob/7fdd7a18/apps/helixprotx/model_config.py#L34-L58)
 ...
 [apps/helixprotx/model_config.py L60-L80](https://github.com/PaddlePaddle/PaddleHelix/blob/7fdd7a18/apps/helixprotx/model_config.py#L60-L80)

 [apps/helixprotx/model_config.py L82-L113](https://github.com/PaddlePaddle/PaddleHelix/blob/7fdd7a18/apps/helixprotx/model_config.py#L82-L113)
...
INPUTIDS["input_ids<br>Tokenized sequences"]
ATTMASK["attention_mask<br>Valid token indicators"]
STRUCTENC["structure_encoder_outputs<br>EncoderOutput"]
SEQENC["sequence_encoder_outputs<br>EncoderOutput"]
ANGLEMASK["angle_mask<br>Numerical token positions"]
LMOUT["language_model_outputs<br>CausalLMOutputWithPast"]
NUMOUT["number_decoder_outputs<br>NumberDecoderOutput"]
GENOUT["HelixProtXGenerationOutput"]
STRUCTIDX["struc_idx<br>Structure sample indices"]
SEQIDX["seq_idx<br>Sequence sample indices"]
ANGLEIDX["angle_idx<br>Angle prediction indices"]
...
subgraph Processing_Indices ["Processing_Indices"]
    STRUCTIDX
    SEQIDX
    ANGLEIDX
end
...
**Sources:** [apps/helixprotx/inference.py L24-L80](https://github.com/PaddlePaddle/PaddleHelix/blob/7fdd7a18/apps/helixprotx/inference.py#L24-L80)

 [apps/helixprotx/model_config.py L196-L221](https://github.com/PaddlePaddle/PaddleHelix/blob/7fdd7a18/apps/helixprotx/model_config.py#L196-L221)
...
```python
# Configuration alignment example from build_model.pyresidue_embedding_config = ResidueEmbeddingConfig(    output_hidden_size=text_config.hidden_size)number_decoder_config = NumberDecoderConfig(    hidden_size=text_config.hidden_size  )
```

**Sources:** [apps/helixprotx/build_model.py L24-L58](https://github.com/PaddlePaddle/PaddleHelix/blob/7fdd7a18/apps/helixprotx/build_model.py#L24-L58)
...
**Sources:** [apps/helixprotx/inference.py L83-L113](https://github.com/PaddlePaddle/PaddleHelix/blob/7fdd7a18/apps/helixprotx/inference.py#L83-L113)
...
**Sources:** [apps/helixprotx/requirements.txt L1-L11](https://github.com/PaddlePaddle/PaddleHelix/blob/7fdd7a18/apps/helixprotx/requirements.txt#L1-L11)
 ...
 [apps/helixprotx/README.md L19-L32](https://github.com/PaddlePaddle/PaddleHelix/blob/7fdd7a18/apps/helixprotx/README.md?plain=1#L19-L32)