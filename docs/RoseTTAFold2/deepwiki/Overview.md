...
For detailed information about installation and basic usage, see [Getting Started](/uw-ipd/RoseTTAFold2/2-getting-started). For deep technical details about the neural network architecture, see [Core Architecture](/uw-ipd/RoseTTAFold2/3-core-architecture). For information about the prediction workflow, see [Prediction Pipeline](/uw-ipd/RoseTTAFold2/4-prediction-pipeline).
...
**Sources:** [network/predict.py L1-L637](https://github.com/uw-ipd/RoseTTAFold2/blob/4b273b95/network/predict.py#L1-L637)

 [network/RoseTTAFoldModel.py L1-L149](https://github.com/uw-ipd/RoseTTAFold2/blob/4b273b95/network/RoseTTAFoldModel.py#L1-L149)

 [README.md L1-L107](https://github.com/uw-ipd/RoseTTAFold2/blob/4b273b95/README.md?plain=1#L1-L107)
...
**Sources:** [network/predict.py L204-L249](https://github.com/uw-ipd/RoseTTAFold2/blob/4b273b95/network/predict.py#L204-L249)

 [network/RoseTTAFoldModel.py L11-L41](https://github.com/uw-ipd/RoseTTAFold2/blob/4b273b95/network/RoseTTAFoldModel.py#L11-L41)

 [network/predict.py L53-L94](https://github.com/uw-ipd/RoseTTAFold2/blob/4b273b95/network/predict.py#L53-L94)
...
**Sources:** [network/predict.py L251-L438](https://github.com/uw-ipd/RoseTTAFold2/blob/4b273b95/network/predict.py#L251-L438)

 [network/predict.py L496-L556](https://github.com/uw-ipd/RoseTTAFold2/blob/4b273b95/network/predict.py#L496-L556)
...
| --- | --- | --- |
| `n_main_block` | 36 | Number of main transformer blocks |
...
**Sources:** [network/predict.py L53-L66](https://github.com/uw-ipd/RoseTTAFold2/blob/4b273b95/network/predict.py#L53-L66)
 ...
 [network/predict.py L96-L136](https://github.com/uw-ipd/RoseTTAFold2/blob/4b273b95/network/predict.py#L96-L136)
...
**Sources:** [network/predict.py L204-L637](https://github.com/uw-ipd/RoseTTAFold2/blob/4b273b95/network/predict.py#L204-L637)

 [network/RoseTTAFoldModel.py L52-L148](https://github.com/uw-ipd/RoseTTAFold2/blob/4b273b95/network/RoseTTAFoldModel.py#L52-L148)