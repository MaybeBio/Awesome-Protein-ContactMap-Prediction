...
For information about training models from scratch, see [Training Execution](/bytedance/Protenix/6.2-training-execution). For loading models during inference, see [Running Inference](/bytedance/Protenix/3.4-running-inference). For configuration details, see [Configuration System](/bytedance/Protenix/7-configuration-system).
...
Sources: [runner/train.py L62-L70](https://github.com/bytedance/Protenix/blob/c3bfc365/runner/train.py#L62-L70)
...
Sources: [runner/train.py L226-L240](https://github.com/bytedance/Protenix/blob/c3bfc365/runner/train.py#L226-L240)

 (Note: Reference to internal dictionary structure during save/load logic).
...
subgraph subGraph1 ["_load_checkpoint() Logic"]
    ...
    Validate --> LoadFile
    LoadFile --> CheckDDP
    CheckDDP --> StripPrefix
    CheckDDP --> LoadModel
    StripPrefix --> LoadModel
    LoadModel --> CheckParamsOnly
    CheckParamsOnly --> LoadOptim
    LoadOptim --> LoadStep
    LoadStep --> LoadSched
...
Sources: [runner/train.py L242-L309](https://github.com/bytedance/Protenix/blob/c3bfc365/runner/train.py#L242-L309)
...
| --- | --- | --- | --- |
| `load_checkpoint_path` | `str` | `None` | Path to main checkpoint file |
| `load_ema_checkpoint_path` | `str` | `None` | Path to EMA checkpoint file |
| `load_params_only` | `bool` | `False` | Load only model weights, skip optimizer/scheduler |
| `load_strict` | `bool` | `True` | Strict model state dict loading |
| `skip_load_optimizer` | `bool` | `False` | Skip restoring optimizer state |
| `skip_load_scheduler` | `bool` | `False` | Skip restoring scheduler state |
| `skip_load_step` | `bool` | `False` | Skip restoring step counter |
| `load_step_for_scheduler` | `bool` | `True` | Reinitialize scheduler with loaded step |
...
Sources: [runner/train.py L258-L264](https://github.com/bytedance/Protenix/blob/c3bfc365/runner/train.py#L258-L264)
...
Sources: [protenix/utils/training.py L73-L115](https://github.com/bytedance/Protenix/blob/c3bfc365/protenix/utils/training.py#L73-L115)

### Usage Example from finetune_demo.sh
...
Sources: [finetune_demo.sh L26-L51](https://github.com/bytedance/Protenix/blob/c3bfc365/finetune_demo.sh#L26-L51)
...
Sources: [runner/train.py L37](https://github.com/bytedance/Protenix/blob/c3bfc365/runner/train.py#L37-L37)
...
Sources: [runner/train.py L291-L297](https://github.com/bytedance/Protenix/blob/c3bfc365/runner/train.py#L291-L297)

 [runner/ema.py](https://github.com/bytedance/Protenix/blob/c3bfc365/runner/ema.py)
...
| --- | --- | --- |
| **Layernorm** | `fast_layernorm` (default), `torch` | [docs/kernels.md L3-L9](https://github.com/bytedance/Protenix/blob/c3bfc365/docs/kernels.md?plain=1#L3-L9) |
| **Triangle Attention** | `triattention`, `cuequivariance`, `deepspeed`, `torch` | [docs/kernels.md L10-L14](https://github.com/bytedance/Protenix/blob/c3bfc365/docs/kernels.md?plain=1#L10-L14) |
| **Triangle Multiplicative** | `cuequivariance`, `torch` | [docs/kernels.md L39-L44](https://github.com/bytedance/Protenix/blob/c3bfc365/docs/kernels.md?plain=1#L39-L44) |
...
Sources: [docs/kernels.md L1-L52](https://github.com/bytedance/Protenix/blob/c3bfc365/docs/kernels.md?plain=1#L1-L52)
 ...
 [finetune_demo.sh L15-L19](https://github.com/bytedance/Protenix/blob/c3bfc365/finetune_demo.sh#L15-L19)

---

## Execution and Configuration

### Fine-tuning Execution (finetune_demo.sh)
...
Sources: [runner/train.py L54-L309](https://github.com/bytedance/Protenix/blob/c3bfc365/runner/train.py#L54-L309)
 ...
 [finetune_demo.sh L1-L51](https://github.com/bytedance/Protenix/blob/c3bfc365/finetune_demo.sh#L1-L51)