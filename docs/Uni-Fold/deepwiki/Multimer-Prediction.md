...
For information about the core AlphaFold model architecture, see [Core AlphaFold Model](/dptech-corp/Uni-Fold/5.1-core-alphafold-model). For symmetric protein complexes, see [UF-Symmetry System](/dptech-corp/Uni-Fold/7.1-uf-symmetry-system).
...
K["Template Features"]
L["pair_sequences()"]
M["create_paired_features()"]
N["merge_chain_features()"]
...
Sources: [unifold/dataset.py L399-L535](https://github.com/dptech-corp/Uni-Fold/blob/7b55789e/unifold/dataset.py#L399-L535)
 ...
 [unifold/data/msa_pairing.py L72-L104](https://github.com/dptech-corp/Uni-Fold/blob/7b55789e/unifold/data/msa_pairing.py#L72-L104)
...
A["UnifoldMultimerDataset"]
B["pdb_assembly.json"]
C["pdb_features/"]
D["pdb_uniprots/"]
E["pdb_labels/"]
F["Chain IDs + Operations"]
G["Individual Chain Features"]
H["UniProt MSAs"]
I["Structure Labels"]
J["load_and_process()"]
K["Paired Complex Features"]
...
Sources: [unifold/dataset.py L416-L422](https://github.com/dptech-corp/Uni-Fold/blob/7b55789e/unifold/dataset.py#L416-L422)

 [unifold/dataset.py L432-L481](https://github.com/dptech-corp/Uni-Fold/blob/7b55789e/unifold/dataset.py#L432-L481)
...
Sources: [unifold/dataset.py L444-L457](https://github.com/dptech-corp/Uni-Fold/blob/7b55789e/unifold/dataset.py#L444-L457)

 [unifold/dataset.py L513-L534](https://github.com/dptech-corp/Uni-Fold/blob/7b55789e/unifold/dataset.py#L513-L534)
...
E["Common Species Detection"]
F["_match_rows_by_sequence_similarity()"]
G["pair_sequences()"]
H["reorder_paired_rows()"]
I["Paired MSA Indices"]
J["msa_species_identifiers"]
K["Sequence Similarity"]
L["Gap Content"]
...
Sources: [unifold/data/msa_pairing.py L207-L262](https://github.com/dptech-corp/Uni-Fold/blob/7b55789e/unifold/data/msa_pairing.py#L207-L262)

 [unifold/data/msa_pairing.py L137-L157](https://github.com/dptech-corp/Uni-Fold/blob/7b55789e/unifold/data/msa_pairing.py#L137-L157)
...
Sources: [unifold/data/msa_pairing.py L168-L204](https://github.com/dptech-corp/Uni-Fold/blob/7b55789e/unifold/data/msa_pairing.py#L168-L204)

 [unifold/data/msa_pairing.py L27-L29](https://github.com/dptech-corp/Uni-Fold/blob/7b55789e/unifold/data/msa_pairing.py#L27-L29)

 [unifold/data/msa_pairing.py L243-L253](https://github.com/dptech-corp/Uni-Fold/blob/7b55789e/unifold/data/msa_pairing.py#L243-L253)
...
B["_merge_homomers_dense_msa()"]
C["_merge_features_from_multiple_chains()"]
D["_concatenate_paired_and_unpaired_features()"]
E["_correct_post_merged_feats()"]
F["Complex Features"]
G["MSA Features"]
H["Block Diagonal / Concatenate"]
I["Sequence Features"]
J["Concatenate"]
K["Template Features"]
L["Concatenate along chain dim"]
...
Sources: [unifold/data/msa_pairing.py L466-L494](https://github.com/dptech-corp/Uni-Fold/blob/7b55789e/unifold/data/msa_pairing.py#L466-L494)

 [unifold/data/msa_pairing.py L368-L413](https://github.com/dptech-corp/Uni-Fold/blob/7b55789e/unifold/data/msa_pairing.py#L368-L413)
...
Sources: [unifold/data/msa_pairing.py L384-L413](https://github.com/dptech-corp/Uni-Fold/blob/7b55789e/unifold/data/msa_pairing.py#L384-L413)

 [unifold/data/msa_pairing.py L42-L69](https://github.com/dptech-corp/Uni-Fold/blob/7b55789e/unifold/data/msa_pairing.py#L42-L69)
...
Sources: [unifold/data/process.py L64-L71](https://github.com/dptech-corp/Uni-Fold/blob/7b55789e/unifold/data/process.py#L64-L71)

 [unifold/data/process.py L97-L101](https://github.com/dptech-corp/Uni-Fold/blob/7b55789e/unifold/data/process.py#L97-L101)

 [unifold/data/process.py L120-L124](https://github.com/dptech-corp/Uni-Fold/blob/7b55789e/unifold/data/process.py#L120-L124)
...
A["crop_to_size_multimer()"]
B["spatial_crop_prob"]
C["ca_ca_threshold"]
D["Cross-chain Contact Map"]
E["Spatially-aware Crop"]
F["Complex Features"]
G["Fixed Size Features"]
...
Sources: [unifold/dataset.py L47-L48](https://github.com/dptech-corp/Uni-Fold/blob/7b55789e/unifold/dataset.py#L47-L48)

 [unifold/data/data_ops.py L186-L235](https://github.com/dptech-corp/Uni-Fold/blob/7b55789e/unifold/data/data_ops.py#L186-L235)

 [unifold/data/msa_pairing.py L301-L342](https://github.com/dptech-corp/Uni-Fold/blob/7b55789e/unifold/data/msa_pairing.py#L301-L342)