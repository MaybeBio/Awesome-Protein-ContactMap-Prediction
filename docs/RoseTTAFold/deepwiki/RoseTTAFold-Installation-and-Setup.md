...
repo: RoseTTAFold
url: https://deepwiki.com/RosettaCommons/RoseTTAFold/2-installation-and-setup
---
...
> - [install\_dependencies\.sh](https://github.com/RosettaCommons/RoseTTAFold/blob/fcf9125c/install_dependencies.sh)
 ...
 For information about using RoseTTAFold after installation, see [Input Preparation Pipeline](https://deepwiki.com/RosettaCommons/RoseTTAFold/3-input-preparation-pipeline) and [Prediction Pipelines](https://deepwiki.com/RosettaCommons/RoseTTAFold/4-prediction-pipelines)\.
...
```
 ...
 Sources: [README\.md?plain=1 L7-L11](https://github.com/RosettaCommons/RoseTTAFold/blob/fcf9125c/README.md?plain=1#L7-L11)
...
- parallel \(GNU parallel\)
 ...
 Sources: [README\.md?plain=1 L13-L23](https://github.com/RosettaCommons/RoseTTAFold/blob/fcf9125c/README.md?plain=1#L13-L23) [RoseTTAFold\-linux\.yml L1-L109](https://github.com/RosettaCommons/RoseTTAFold/blob/fcf9125c/RoseTTAFold-linux.yml#L1-L109) [folding\-linux\.yml L1-L9](https://github.com/RosettaCommons/RoseTTAFold/blob/fcf9125c/folding-linux.yml#L1-L9)
 ...
 **Note:** The model weights are available for non\-commercial use only under the Rosetta\-DL Software license\. See [https://files\.ipd\.uw\.edu/pub/RoseTTAFold/Rosetta\-DL\_LICENSE\.txt](https://files.ipd.uw.edu/pub/RoseTTAFold/Rosetta-DL_LICENSE.txt) for details\.

 Sources: [README\.md?plain=1 L25-L33](https://github.com/RosettaCommons/RoseTTAFold/blob/fcf9125c/README.md?plain=1#L25-L33)
...
- **cs\-blast** \- Tool for context\-specific sequence searches
 ...
 Sources: [README\.md?plain=1 L35-L38](https://github.com/RosettaCommons/RoseTTAFold/blob/fcf9125c/README.md?plain=1#L35-L38) [install\_dependencies\.sh L1-L28](https://github.com/RosettaCommons/RoseTTAFold/blob/fcf9125c/install_dependencies.sh#L1-L28)
 ...
 **Note:** For CASP14 benchmarks, a different version was used: `https://files.ipd.uw.edu/pub/RoseTTAFold/pdb100_2020Mar11.tar.gz`
 ...
 Sources: [README\.md?plain=1 L40-L56](https://github.com/RosettaCommons/RoseTTAFold/blob/fcf9125c/README.md?plain=1#L40-L56) [make\_msa\.sh L1-L60](https://github.com/RosettaCommons/RoseTTAFold/blob/fcf9125c/input_prep/make_msa.sh#L1-L60)
...
```
 ...
 Sources: [README\.md?plain=1 L58](https://github.com/RosettaCommons/RoseTTAFold/blob/fcf9125c/README.md?plain=1#L58-L58)
...
```
 ...
 Sources: [make\_msa\.sh L15-L17](https://github.com/RosettaCommons/RoseTTAFold/blob/fcf9125c/input_prep/make_msa.sh#L15-L17)
...
| PyRosetta Structure Modeling | 8\+ | 16GB\+ | 4GB\+ | Input: <1GBOutput: <1GB |
 ...
 This completes the installation and setup of RoseTTAFold\. For information on running predictions, see [Prediction Pipelines](https://deepwiki.com/RosettaCommons/RoseTTAFold/4-prediction-pipelines)\.

---
*Source: [https://deepwiki.com/RosettaCommons/RoseTTAFold/2-installation-and-setup](https://deepwiki.com/RosettaCommons/RoseTTAFold/2-installation-and-setup) on DeepWiki*