---
title: "RoseTTAFold Overview"
source: deepwiki.com
owner: RosettaCommons
repo: RoseTTAFold
url: https://deepwiki.com/RosettaCommons/RoseTTAFold/1-rosettafold-overview
---
...
> - [README\.md](https://github.com/RosettaCommons/RoseTTAFold/blob/fcf9125c/README.md?plain=1)
 ...
 For installation instructions, see [Installation and Setup](https://deepwiki.com/RosettaCommons/RoseTTAFold/2-installation-and-setup)\. For details on preparing input data, see [Input Preparation Pipeline](https://deepwiki.com/RosettaCommons/RoseTTAFold/3-input-preparation-pipeline)\. For specific prediction methodologies, see [Prediction Pipelines](https://deepwiki.com/RosettaCommons/RoseTTAFold/4-prediction-pipelines)\. For in\-depth details about the neural networks, see [Neural Network Architecture](https://deepwiki.com/RosettaCommons/RoseTTAFold/5-neural-network-architecture)\.
...
- Screening for protein\-protein interactions \(PPI\)
 ...
 Sources: [README\.md?plain=1 L1-L3](https://github.com/RosettaCommons/RoseTTAFold/blob/fcf9125c/README.md?plain=1#L1-L3)
...
```
 ...
 Sources: [README\.md?plain=1 L5-L78](https://github.com/RosettaCommons/RoseTTAFold/blob/fcf9125c/README.md?plain=1#L5-L78)
...
3. Template identification using `hhsearch` \(searching PDB100 database\)
 ...
 Sources: [README\.md?plain=1 L42-L56](https://github.com/RosettaCommons/RoseTTAFold/blob/fcf9125c/README.md?plain=1#L42-L56)
...
- **Structure Track**: Manages 3D coordinate information using SE\(3\)\-equivariant transformers from `network/equivariant_attention`
 ...
 Sources: [README\.md?plain=1 L92-L94](https://github.com/RosettaCommons/RoseTTAFold/blob/fcf9125c/README.md?plain=1#L92-L94)
...
| --- | --- | --- | --- | --- |
| End\-to\-End | predict\_e2e\.py | 3\-Track | Single PDB with CA\-lddt | Direct 3D prediction, fastest for single structures |
| PyRosetta | predict\_pyRosetta\.py | 3\-Track | Five PDBs with CA rms error | Higher quality, multiple diverse models |
| Complex | predict\_complex\.py | 3\-Track | Complex PDB | Models multiple chains, captures interfaces |
| PPI Screening | predict\_msa\.py | 2\-Track | Interaction scores \(\.npz\) | Fast screening, lower memory requirements |
...
| --- | --- | --- | --- |
| End\-to\-End | t000\_\.e2e\.pdb | PDB | 3D coordinates with residue\-wise CA\-lddt in B\-factor column |
| PyRosetta | model/model\_\[1\-5\]\.crderr\.pdb | PDB | 3D coordinates with estimated CA rms error in B\-factor column |
...
2. I\.R\. Humphreys, J\. Pei, M\. Baek, A\. Krishnakumar, et al, "Computed structures of core eukaryotic protein complexes," Science \(2021\)\.
 ...
 Sources: [README\.md?plain=1 L92-L101](https://github.com/RosettaCommons/RoseTTAFold/blob/fcf9125c/README.md?plain=1#L92-L101)

---
*Source: [https://deepwiki.com/RosettaCommons/RoseTTAFold/1-rosettafold-overview](https://deepwiki.com/RosettaCommons/RoseTTAFold/1-rosettafold-overview) on DeepWiki*